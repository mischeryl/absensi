...
<body>
    ...
    <div class="utama">
        <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top: 10px;">
            ...
            <tr>
                <td valign="top">&nbsp;SMK Wikrama Bogor</td>
            </tr>
            <tr>
        ...
        <table cellspacing="1" align="center" border="1">
            ...
            <?php 
                ...
                if ($bulan == $ambil_bulan) {
                    $sql = mysqli_query($koneksi, "SELECT SUM(hadir) AS hadir, SUM(sakit) AS sakit, SUM(ijin) AS ijin, SUM(alpa) AS alpa, nis, nama, rombel, tgl_absen, id_rombel FROM query_absen WHERE id_rombel = '$_GET[rombel]' GROUP BY nis");
                    $no = 0;
            ...
            <tr align="center">
                ...
                <td><?= date('M') ?></td>
                <td>
                    <a target="_blank" href="laporan_rombel_detail.php?rombel<?= $r['id_rombel']; ?>&nis=<?= $r['nis']; ?>&tgl=<?= $r['tgl_absen']; ?>">Detail</a>
                </td>
            </tr>
            <?php }} ?>
        </table>
